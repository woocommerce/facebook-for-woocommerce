	...
	public function enqueue_scripts() {
		...
		if ( isset( $current_screen->id ) ) {
			...
			if ( 'product' === $current_screen->id || 'edit-product' === $current_screen->id ) {
				...
				wp_enqueue_script( 'facebook-for-woocommerce-products-admin', facebook_for_woocommerce()->get_plugin_url() . '/assets/js/admin/facebook-for-woocommerce-products-admin.js', array( 'jquery', 'wc-backbone-modal', 'jquery-blockui', 'facebook-for-woocommerce-modal' ), \WC_Facebookcommerce::PLUGIN_VERSION );
